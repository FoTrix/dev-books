import { G as decryptString, H as createSlotValueFromString, J as isAstroComponentFactory, b as renderComponent, r as renderTemplate, K as ROUTE_TYPE_HEADER, O as REROUTE_DIRECTIVE_HEADER, A as AstroError, P as i18nNoLocaleFoundInPath, Q as ResponseSentError, S as MiddlewareNoDataOrNextCalled, T as MiddlewareNotAResponse, V as originPathnameSymbol, W as RewriteWithBodyUsed, X as GetStaticPathsRequired, Y as InvalidGetStaticPathsReturn, Z as InvalidGetStaticPathsEntry, _ as GetStaticPathsExpectedParams, $ as GetStaticPathsInvalidRouteParam, a0 as PageNumberParamNotFound, D as DEFAULT_404_COMPONENT, a1 as ActionNotFoundError, a2 as NoMatchingStaticPathFound, a3 as PrerenderDynamicEndpointPathCollide, a4 as ReservedSlotName, a5 as renderSlotToString, a6 as renderJSX, a7 as chunkToString, a8 as isRenderInstruction, a9 as ForbiddenRewrite, aa as SessionStorageSaveError, ab as SessionStorageInitError, ac as ASTRO_VERSION, ad as LocalsReassigned, ae as PrerenderClientAddressNotAvailable, af as clientAddressSymbol, ag as ClientAddressNotAvailable, ah as StaticClientAddressNotAvailable, ai as AstroResponseHeadersReassigned, aj as responseSentSymbol$1, ak as renderPage, al as REWRITE_DIRECTIVE_HEADER_KEY, am as REWRITE_DIRECTIVE_HEADER_VALUE, an as renderEndpoint, ao as LocalsNotAnObject, ap as REROUTABLE_STATUS_CODES } from './astro/server_jkKJgDP7.mjs';
import { bold, red, yellow, dim, blue } from 'kleur/colors';
import 'clsx';
import { serialize, parse as parse$2 } from 'cookie';
import { A as ActionError, d as deserializeActionResult, s as serializeActionResult, a as ACTION_RPC_ROUTE_PATTERN, b as ACTION_QUERY_PARAMS, g as getActionQueryString, D as DEFAULT_404_ROUTE, c as default404Instance, N as NOOP_MIDDLEWARE_FN, e as ensure404Route } from './astro-designed-error-pages_BEXYyAPH.mjs';
...
import { a as setGetEnv } from './runtime_7nYLwR8d.mjs';
...
class AstroCookies {
  ...
  *headers() {
  ...
  #parse(options = void 0) {
    ...
    this.#requestValues = parse$2(raw, options);
  }
}
