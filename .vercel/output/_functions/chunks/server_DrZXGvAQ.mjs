import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from './runtime_7nYLwR8d.mjs';

const schema = {"SHOW_BUY_BUTTON":{"context":"server","access":"public","default":true,"type":"boolean"},"SCORE_API_URL":{"context":"server","access":"public","type":"string"},"REPO_API_URL":{"context":"server","access":"secret","type":"string"}};
...
setOnSetGetEnv(() => {
	REPO_API_URL = _internalGetSecret("REPO_API_URL");

});
const SCORE_API_URL = "https://www.random.org/integers/?num=1&min=1&max=5&col=1&base=10&format=plain&rnd=new";let REPO_API_URL = _internalGetSecret("REPO_API_URL");

export { REPO_API_URL as R, SCORE_API_URL as S };
